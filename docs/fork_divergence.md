...
**Last audited against:** upstream/main HEAD (`fe0ec8b5`) — v5.12.2 (chat idle-watchdog/spinner fix, notes-index SQL query engine, Antigravity/agy replaces Gemini CLI runtime, taskmanager pagination + wikilink-coercion fixes, gpt-5.4-image-2)  

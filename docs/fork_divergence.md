...
**Last audited against:** upstream/main HEAD (`bb496e9e`) — v5.14.0 (native Mistral OCR + PDF image extraction + OCR-truncation fix; Claude Sonnet 5 added to Anthropic/OpenRouter/Requesty)  

...
**Last audited against:** upstream/main HEAD (`efcac800`) — v5.13.1 (local-model upgrades: Ollama native tool-calling/structured-output/discovery + LM Studio/Ollama native thinking/resilient streaming; working-indicator continuity; content-replace anchor-drift tolerance; store-bot lint fix)  

...
**Last audited against:** upstream/main HEAD (`d3e612fe`) — v5.15.2 (local CLI agent bridge `nexus`, vault-path confinement security hardening, TypeScript 6 migration, storage-cutover fix, GPT-5.6 family, Windows CLI hardening)  

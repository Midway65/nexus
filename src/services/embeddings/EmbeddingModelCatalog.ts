...
export const EMBEDDING_MODELS: EmbeddingModelEntry[] = [
  {
    ...
    description: 'High-quality 768-dim model. Best semantic quality. Requires download on first use.',
  ...
  },
  {
    ...
    dimensions: 384,
    quantizedSize: '~23 MB',
    description: 'Fast 384-dim model. Smaller download, lower quality than Nomic.',
    documentPrefix: null,
    queryPrefix: null,
    requiresMeanPool: true,
    normalizeInPipeline: true,
  },
  {
    ...
    dimensions: 384,
    quantizedSize: '~25 MB',
    description: 'Fast 384-dim model from BAAI. Good quality for English text.',
    documentPrefix: null,
